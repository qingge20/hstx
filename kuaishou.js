...
///////////////////////////////////////////////////////////////////
let Version = '\n  2022/5/13-2      完成签到,宝箱,分享 功能,请使用完整版ck\n'
let thank = `\n \n`
let test = `\n TG:https://t.me/+YpIbFCu6TX03MGY1     TG:https://t.me/+YpIbFCu6TX03MGY1\n`
///////////////////////////////////////////////////////////////////
...
async function Share(id) {
	...
	if (result.result == 1) {
		console.log(`\n 分享: TG群:https://t.me/+YpIbFCu6TX03MGY1获得 金币 ${result.data.amount} 枚!\n`);
		msg += `\n 分享: TG群:https://t.me/+YpIbFCu6TX03MGY1获得 金币 ${result.data.amount} 枚!\n`;
	...
	return new Promise((resolve) => {
		...
		$.get(url, async (err, resp, data) => {
			try {
				...
				console.log(`\n 【TG群:https://t.me/+YpIbFCu6TX03MGY1】: ${data.content} ` );
